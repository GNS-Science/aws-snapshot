...
─────────────────────────────        ──────────────────────────────
nzshm22-toy-inv-source     ────►     bb-toy-inv-s3-src-…-461564345538
nzshm22-toy-noinv-source   ────►     bb-toy-noinv-s3-src-…-461564345538
```
...
|---|---|---|---|
| 1 | `aws s3api delete-object --bucket bb-toy-inv-s3-src-…-461564345538 --key data/file-01.txt --version-id <v>` (admin override of the no-delete bucket policy) | `toy-inv` | ⚠ class-1 RED: "backup is missing 1 source keys" |
...
| # | Recovery action |
|---|---|
| 1 | `aws s3 cp s3://nzshm22-toy-inv-source/data/file-01.txt s3://bb-toy-inv-s3-src-…-461564345538/data/file-01.txt` |
